...
- nix flakes
#+begin_src sh :async t :exports both :results output
nix build github:hardenedlinux/zeek-nix --option substituters "https://cache.nixos.org http://221.4.35.244:8301" --option trusted-public-keys "221.4.35.244:3ehdeUIC5gWzY+I7iF3lrpmxOMyEZQbZlcjOmlOVpeo="
#+end_src
...
* TODO Deploy Zeek kafka topics with Nix home-manager on Debian(OS) => Disnix
