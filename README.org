...
#+begin_src sh :async t :exports both :results output
nix build  --option sandbox false --option substituters "https://cache.nixos.org http://221.4.35.244:8301" --option trusted-public-keys "221.4.35.244:3ehdeUIC5gWzY+I7iF3lrpmxOMyEZQbZlcjOmlOVpeo= cache.nixos.org-1:${yourtrustkey check nix.conf }"
#+end_src
** Using Nix zeek Script manager
#+begin_src sh :async t :exports both :results output
git clone https://github.com/hardenedlinux/zeek-nix
cd zeek-scripts
nix-build
