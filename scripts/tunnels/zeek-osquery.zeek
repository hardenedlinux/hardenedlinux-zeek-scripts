...
redef Kafka::kafka_conf = table(["metadata.broker.list"] = "localhost:9200"
...
event zeek_init() &priority=-10
{
	...
	Log::add_filter(osquery::process_connections::LOG,
	    filter_osq_process_connections);
	...
	Log::add_filter(osquery::logging::process_open_sockets::LOG,
	    filter_osq_process_open_sockets);
	...
	Log::add_filter(osquery::logging::process_events::LOG,
	    filter_osq_process_events);
